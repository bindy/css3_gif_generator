(function() {
    ...
    $('#ID_btn_theme').on('change', function(e) {
        ...
        function _createSprite() {
            ...
            var canvas_h = document.createElement('canvas');


            canvas_h.width = aniMap.obj.fileWidth * aniMap.obj.fileNum;
            canvas_h.height = aniMap.obj.fileHeight;
            ...
            function __create(data, index) {
                ...
                img.onload = function(args, imgdata, all) {
                    ...
                    return function() {
                        ...
                        ctx_h.drawImage(imgdata, (args - 1) * imgWidth, 0, imgWidth, imgHeight)
                        ...
                        if (args == all) {
                            ...
                            var aniSpriteH = canvas_h.toDataURL("image/png");
                            ...
                            $.ajax('server/compress.php', {
                                ...
                                success: function(data) {
                                    if (data) {
                                        ...
                                        var styleText = '@-webkit-keyframes ani' + imgHeight + '{0%{background-position: 0 0;}100%{background-position: -' + imgWidth * all + 'px 0;}}';
